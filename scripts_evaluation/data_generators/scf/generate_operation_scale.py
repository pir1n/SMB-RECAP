...
from scripts.data_generators.scf.generate_ops import content_for, content_hash_for
...
def render_workload(client, plan_path, out_dir, args):
    if client == "cmd":
        from scripts.data_generators.scf.render_cmd import fast_sidecar_path, render

        from smbmount.shared.evaluation import read_jsonl
    ...
    if client == "powershell":
        from scripts.data_generators.scf.render_powershell import render
    ...
    if client == "smbclient":
        from scripts.data_generators.scf.render_smbclient import render
